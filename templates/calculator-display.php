...
if ( ! $product instanceof WC_Product ) {
    return; // Stop als er geen geldig product is
}

// Bepaal of het een variabel product betreft
$isVariableProduct = $product->is_type( 'variable' );
$calculatorDisabledClass = $isVariableProduct ? 'calculator-disabled' : '';

// Zorg ervoor dat de benodigde variabelen bestaan (bijv. vanuit de context of fallback)
...
$calculation_mode    = $calculation_mode ?? 'kg_per_mm';
?>
