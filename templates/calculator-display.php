...
<?php if ($isVariableProduct): ?>
    <p class="calculator-warning" style="color: red; font-weight: bold;" role="alert">
    ...
    >
        ...
        <div class="total-price">
            <div class="total-price-row">
                ...
                <span class="calc-variation-price" style="display:none"></span>
            </div>
        ...
        <p id="egaline-calculator-error" class="calc-error" role="alert" aria-live="polite" style="display:none"></p>
    </div>
